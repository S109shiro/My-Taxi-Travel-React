...
function Header({user = {}, logIn = false}){
    return <>
        <header className="text-gray-600 body-font bg-[var(--bg)]">
            ...
            >
                <a
                    className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0" href="index.html"
                >
                    <svg
                    ...
                    <span className="ml-3 text-xl hover:text-white cursor-pointer transition delay-100 ease-in-out">My Taxi Travel</span>
                </a>
                <nav
                ...
                <a href="./paginas/login/login.html">
                    <button
                        className="inline-flex items-center bg-gray-300 border-1 border-black rounded-lg py-1 px-3 focus:outline-none hover:bg-gray-100 hover:text-black rounded text-base mt-4 md:mt-0 cursor-pointer transition delay-100 ease-in-out mr-2"
                    >
                        Login
                        <svg
                            fill="none"
                ...
                <button
                    onClick="cambiarTema()" id="boton-tema" className="inline-flex items-center border-1 border-black bg-[#2C2C2C] rounded-lg py-1 px-3 focus:outline-none hover:bg-gray-200 hover:text-black rounded text-base mt-4 md:mt-0 cursor-pointer transition delay-100 ease-in-out text-white"
                >
                    Modo Oscuro 🌙
                </button>
            </div>
